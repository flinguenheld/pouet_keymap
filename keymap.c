...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOLS] = LAYOUT(
    //----------------+-------------+-------------+-------------+----------|       |----------+-------------+-------------+-------------+-------------|
           KC_HASH    ,   KC_LBRC   ,   KC_AMPR   ,   KC_LBRC   ,  XXXXXXX ,          XXXXXXX ,  KC_GRAVE   ,   KC_EXLM   ,    KC_AT    ,   XXXXXXX   ,
    //----------------+-------------+-------------+-------------+----------|       |----------+-------------+-------------+-------------+-------------|
        KC_BACKSLASH  ,   KC_LPRN   ,KC_UNDERSCORE,   KC_RPRN   ,  XXXXXXX ,          XXXXXXX ,  KC_QUOTE   , KC_QUESTION ,   KC_DQUO   ,   XXXXXXX   ,
    //----------------+-------------+-------------+-------------+----------|       |----------+-------------+-------------+-------------+-------------|
           XXXXXXX    ,   KC_LCBR   ,   KC_PIPE   ,   KC_RCBR   ,                                 XXXXXXX   ,   XXXXXXX   ,   XXXXXXX   ,   XXXXXXX   ,
    //----------------+-------------+-------------+-------------|                             |-------------+-------------+-------------+-------------|
    //                                         |---------+---------+---------|   |---------+----------+--------------|
                                                 _______ , XXXXXXX , _______ ,     _______ , KC_COLON , KC_SEMICOLON
    //                                         |---------+---------+---------|   |---------+----------+--------------|
    ),

    [_NUMERIC] = LAYOUT(
    //----------------+-------------+-------------+-------------+----------|       |----------+-------------+-------------+-------------+-------------|
           KC_TILDE   ,   KC_LABK   ,   KC_EQUAL  ,   KC_RABK   ,  XXXXXXX ,          US_PND  ,     KC_7    ,     KC_8    ,     KC_9    ,   KC_DOT    ,
    //----------------+-------------+-------------+-------------+----------|       |----------+-------------+-------------+-------------+-------------|
           KC_PLUS    ,   KC_MINUS  , KC_ASTERISK ,   KC_SLASH  ,  XXXXXXX ,          US_EURO ,     KC_4    ,     KC_5    ,     KC_6    ,    KC_0     ,
    //----------------+-------------+-------------+-------------+----------|       |----------+-------------+-------------+-------------+-------------|
           XXXXXXX    ,   KC_CIRC   ,  KC_PERCENT ,  KC_DOLLAR  ,                                   KC_1    ,     KC_2    ,     KC_3    ,   KC_COMMA  ,
    //----------------+-------------+-------------+-------------|                             |-------------+-------------+-------------+-------------|
    //                                        |----------+--------+---------|   |---------+---------+---------|
                                                KC_COMMA , KC_DOT , _______ ,     _______ , XXXXXXX , _______
    //                                        |----------+--------+---------|   |---------+---------+---------|
    ),
